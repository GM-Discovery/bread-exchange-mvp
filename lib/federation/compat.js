...
// ---- Local identity ----
const LOCAL_CONTRACT_ID = "FEDERATION_CONTRACT_v0_1";

function computeLocalContractHash() {
  // Hardwired path hook: root/FEDERATION_CONTRACT_v0_1.md
  const fp = path.resolve(__dirname, "..", "..", "FEDERATION_CONTRACT_v0_1.md");
